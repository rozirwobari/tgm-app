...
class QcAirBaku extends BaseController
{
    ...
    public function index()
    {
        ...
        $data['qc_air_baku'] = $this->QCModel->orderBy('id', 'DESC')->findAll();
        return view('dashboard/AirBaku/index', $data);
    }
    ...
    public function input()
    {
        ...
        return view('dashboard/AirBaku/input', $data);
    }
    

    public function QCAirBakuInput()
    {
        $rules = [];
        $errors = [];
        for ($i = 1; $i <= 5; $i++) {
    ...
    public function QCAirDetail($id)
    {
        ...
        return view('dashboard/AirBaku/detail', $data);
    }
    ...
    function QCAirExport()
    {
        ...
        $sheet = $spreadsheet->getActiveSheet()->setTitle("QC Air Baku");
        $row = 5;
        $number = 1;
        ...
        $filename = 'qc_air_baku_' . date('Y-m-d') . '.xlsx';
