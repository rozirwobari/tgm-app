...
<form action="<?= base_url('/dashboard/qc_air_galon/update/'.$id) ?>" method="post">
        ...
        <div class="card-body">
            ...
            <div class="input-group my-3">
                <select class="form-control rzw-input <?= session('input.shift') ? 'is-invalid' : '' ?>"
                    ...
                    <option value="1" <?= $details['shift'] == '1' ? 'selected' : '' ?> >1</option>
                    <option value="2" <?= $details['shift'] == '2' ? 'selected' : '' ?> >2</option>
                    <option value="3" <?= $details['shift'] == '3' ? 'selected' : '' ?> >3</option>
                </select>
...
<?php if($status == 0 && $data_user['name'] == "manager"): ?>
    <div class="rzw-box-content">
        <div class="row">
            <div class="col-6">
                <a class="btn btn-primary w-100" href="<?= base_url('dashboard/qc_air_galon/reject/'.$id) ?>"
        ...
        <div class="row mt-3">
            <div class="col-12">
                <a class="btn btn-primary w-100" href="<?= base_url('dashboard/qc_air_galon/approve/'.$id) ?>"
    ...
    function deleteData(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                window.location.href = "<?= base_url('dashboard/qc_air_galon/delete/') ?>" + id;
            }
        });
    }
</script>
